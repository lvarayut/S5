...
var margin = {top: 40, right: 20, bottom: 10, left: 50};
 ...
 var w = 1200,                           //width
    ...
    var pie = d3.layout.pie()           //this will create arc data for us given a list of values
        .value(function(d,i) { return data[i].Duration; });    //we must tell it out to access the value of each element in our data array
	...
	arcs.append("text")
		...
		.text(function(d, i) { 	if((data[i].Duration)>=10) {
